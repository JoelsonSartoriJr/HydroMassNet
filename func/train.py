...
from func.plot import plot_metrics, plot_error

def train_bayesian_regression(layer_dims, x_train, y_train, x_val, y_val, epochs, batch_size, learning_rate, weight_decay, val_split, model_name, scaler_y_fit, input_shape):
    model = BayesianDenseRegression(layer_dims)
